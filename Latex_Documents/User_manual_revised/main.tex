...
\bottomrule
\end{tabularx}
\caption{Core features available in CodeClash Arena}
\end{table}
...
\vspace{1pt}RAM & \vspace{1pt}4 GB & \vspace{1pt}8 GB or more & \vspace{1pt}Multiple browser tabs, smooth multitasking \\
\vspace{1pt}Storage & \vspace{1pt}N/A (web-based) & \vspace{1pt}N/A & \vspace{1pt}No local installation required \\ 
\vspace{1pt}Display & \vspace{1pt}1024x768 resolution & \vspace{1pt}1920x1080 or higher & \vspace{1pt}Comfortable coding environment, split-screen view \\ 
\bottomrule
\end{tabularx}
...
JavaScript Enabled (ES2020+ support) & \textcolor{black}{MANDATORY} \\
Modern CSS Support (Grid, Flexbox gap, backdrop-filter) & \textcolor{black}{MANDATORY} \\
Internet Connection (5+ Mbps recommended) & \textcolor{black}{MANDATORY} \\
CodeClash Arena Account & \textcolor{black}{MANDATORY} \\
Codeforces Account (linked handle) & \textcolor{black}{MANDATORY} \\
Desktop/Laptop Device (for competitive battles) & \textcolor{black}{MANDATORY} \\
Physical Keyboard (for competitive battles) & \textcolor{black}{MANDATORY} \\
