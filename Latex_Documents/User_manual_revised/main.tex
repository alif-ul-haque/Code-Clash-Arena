...
\begin{longtable}{>{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}p{\dimexpr\textwidth-6cm-6\tabcolsep\relax} >{\raggedright\arraybackslash}p{3cm}}
\toprule
...
\end{longtable}
\begin{minipage}{\textwidth}
\captionof{table}{Cross-feature readiness checklist for consistent performance}
\end{minipage}
