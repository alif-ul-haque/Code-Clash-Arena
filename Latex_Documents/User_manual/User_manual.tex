...
\item The overlay menu displays three options: Global Battle, Local Battle, and Practice Gym
\item Click on \textbf{"Global Battle"} option (typically marked with a globe or trophy icon)
\item The Global Battle interface loads
\end{enumerate}

\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Main Dashboard with Attack button highlighted]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Global Battle matchmaking screen with "Find Match" button highlighted]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Match found screen showing opponent details and countdown]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Battle arena showing problem statement on left, code editor on right, timer at top]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Code editor with language dropdown highlighted and Run Code button marked]\vspace{3cm}}}
\caption{Code Editor - Language selection and local testing}
\label{fig:code_editor_test}
\end{figure}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Submit button highlighted and verdict display showing "Accepted"]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Battle result screen showing winner, rating change, and XP earned]\vspace{3cm}}}
...
\item The battle mode selection overlay appears
\item Click on \textbf{"Local Battle"} option (typically marked with a duel icon or crossed swords)
\item The Local Battle configuration page loads
\end{enumerate}

\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Battle mode overlay with Local Battle option highlighted]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Local Battle configuration page with opponent field, difficulty selector, and time limit options marked]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Battle invitation sent screen showing waiting status]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Local Battle arena showing custom settings in header (time limit displayed)]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Incoming battle invitation popup with Accept and Decline buttons highlighted]\vspace{3cm}}}
...
\item In the battle mode overlay, click \textbf{"Practice Gym"} option (typically marked with a dumbbell or training icon)
\item Practice Gym interface loads showing problem browser
\end{enumerate}

\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Battle mode overlay with Practice Gym option highlighted]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Practice Gym problem browser with difficulty filter, tag filter, and problem list visible]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Problem statement view with "Start Solving" button highlighted]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Practice solving interface with problem on left, code editor on right]\vspace{3cm}}}
\caption{Practice Gym - Solving interface}
\label{fig:practice_solving}
\end{figure}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Local testing panel showing input, expected output, actual output, and Run button highlighted]\vspace{3cm}}}
\caption{Practice Gym - Local code testing}
\label{fig:practice_testing}
\end{figure}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Hint button highlighted and hint popup showing logical guidance]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Submit button and verdict display showing "Accepted" with XP earned]\vspace{3cm}}}
\caption{Practice Gym - Submission and verdict}
\label{fig:practice_submit}
\end{figure}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan menu showing Create Clan and Find Clan options]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan creation form with fields for name, tag, description, type, and Create button highlighted]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Newly created clan page showing clan details, your name as leader, and empty statistics]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan browser showing list of available clans with details and "Request to Join" buttons]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan detail page with "Request to Join" button highlighted]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan page showing member list with your name included, clan stats, and chat]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan leader view showing join requests panel with Accept/Reject buttons and member management options]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan Battle button highlighted on dashboard with notification badge]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Warrior selection interface showing clan member list with checkboxes and Confirm button highlighted]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Matchmaking screen showing "Searching for opponent clan" with loading animation]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Opponent clan found screen showing clan names, warrior lists, and countdown timer]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan battle arena showing clan names, scores, problem list, and teammate status]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Problem being solved in clan battle, showing code editor and teammate solving another problem in status panel]\vspace{3cm}}}
\caption{Clan Battle - Warriors solving problems collaboratively}
\label{fig:clan_battle_solving}
\end{figure}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan battle result screen showing Victory, final score, warrior contributions, and points earned]\vspace{3cm}}}
\caption{Clan Battle Result - Victory screen with statistics}
\label{fig:clan_battle_result}
\end{figure}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Main Dashboard with ClashConnect button highlighted, showing notification badge]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: ClashConnect friend list showing usernames, online status, and action buttons]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Find Friends search interface with search bar and "Add Friend" buttons highlighted]\vspace{3cm}}}
\caption{ClashConnect - Search for new friends}
\label{fig:find_friends}
\end{figure}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Pending friend requests with Accept and Reject buttons highlighted]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan join requests panel showing applicant details with Accept/Reject buttons (clan leader view)]\vspace{3cm}}}
...
\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Player profile page showing stats, rating, clan, battle history, and action buttons]\vspace{3cm}}}
\caption{Player Profile - Detailed statistics and social actions}
...
\textbf{Purpose:} View global and clan rankings to track top performers, compare your standing with other players, and monitor clan competition.

\textbf{Step-by-Step Usage:}

\textbf{Step 1: Access Leaderboards}
\begin{enumerate}
\item From Main Dashboard, locate the \textbf{"Leaderboards"} button (may be in navigation menu or separate section)
\item Click \textbf{"Leaderboards"} to open ranking interface
\item Leaderboard page loads showing ranking tabs
\end{enumerate}

\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Navigation menu with Leaderboards button highlighted]\vspace{3cm}}}
\caption{Access Leaderboards from navigation}
\label{fig:leaderboards_access}
\end{figure}

\textbf{Step 2: Global Player Leaderboard}
\begin{enumerate}
\item Default view shows \textbf{"Global Player Rankings"}
\item Leaderboard displays ranked list of players:
  \begin{itemize}
    \item \textbf{Rank}: Position number (1st, 2nd, 3rd, etc.)
    \item \textbf{Username}: Player name (clickable to view profile)
    \item \textbf{Rating}: Current ELO rating
    \item \textbf{Level}: Player level
    \item \textbf{XP}: Total experience points
    \item \textbf{Win/Loss}: Battle record
    \item \textbf{Clan Tag}: Clan affiliation (if any)
  \end{itemize}
\item Top 3 players highlighted with special badges (gold, silver, bronze)
\item Your own rank is highlighted in different color for easy identification
\item Pagination: Navigate through pages to see more players
\end{enumerate}

\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Global leaderboard showing ranked player list with columns for rank, username, rating, level, and win/loss]\vspace{3cm}}}
\caption{Global Player Leaderboard - Top ranked players}
\label{fig:global_leaderboard}
\end{figure}

\textbf{Step 3: Clan Leaderboard}
\begin{enumerate}
\item Click on \textbf{"Clan Rankings"} tab
\item Leaderboard switches to clan rankings showing:
  \begin{itemize}
    \item \textbf{Rank}: Clan position
    \item \textbf{Clan Name and Tag}: Clan identifier
    \item \textbf{Clan Points}: Total clan rating/points
    \item \textbf{Members}: Total member count
    \item \textbf{Battles}: Total clan battles fought
    \item \textbf{Win Rate}: Percentage of battles won
    \item \textbf{Leader}: Clan leader username
  \end{itemize}
\item Top clans highlighted with special styling
\item Your clan (if you're in one) is highlighted
\item Click on clan name to view clan details page
\end{enumerate}

\begin{figure}[!htb]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Screenshot: Clan leaderboard showing ranked clans with points, members, and win rates]\vspace{3cm}}}
\caption{Clan Leaderboard - Top ranked clans}
\label{fig:clan_leaderboard}
\end{figure}

\textbf{Step 4: Filter and Sort Options}
\begin{enumerate}
\item Use filter/sort options to customize leaderboard view:
  \begin{itemize}
    \item \textbf{Time Period}: All-Time, Monthly, Weekly rankings
    \item \textbf{Category}: Rating, XP, Battles Won, Problems Solved
    \item \textbf{Region}: Global, or by specific region (if implemented)
  \end{itemize}
\item Select filter/sort criteria
\item Leaderboard updates dynamically to show filtered results
\end{enumerate}

\textbf{Step 5: View Detailed Player/Clan Profile}
\begin{enumerate}
\item Click on any player username or clan name in the leaderboard
\item Redirected to detailed profile/clan page
\item View complete statistics and battle history
\item Option to add friend, challenge, or join clan (depending on context)
\item Click \textbf{"Back to Leaderboard"} to return
\end{enumerate}
...
\item Final verdict appears (typically within 5-15 seconds):
  \begin{itemize}
    \item \textbf{Accepted (AC)}: All test cases passed ✓ (green color)
